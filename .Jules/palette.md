...
## 2024-05-23 - [Empty States] Contextual Feedback
**Learning:** Generic "No Data" messages are unhelpful. Using relevant emojis/icons (like ⛳ for golf) and actionable advice ("Check filters") reduces user frustration.
**Action:** Always include an icon and a suggestion in empty states.
